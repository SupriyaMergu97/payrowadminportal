...
export class SignatureEncryptionService {
    ...
    async generateKey(keyValidation: string): Promise<Uint8Array> {
        ...
        const combinedBytes = new Uint8Array(deviceIdBytes.length + keyValidationBytes.length);
    ...
    signKey(data: any): string {
        ...
        const key = CryptoJS.enc.Hex.parse("e1f4ea9d3124388d42ce48786f2752c9f0e23bef4b8f7c892cf417d702b86a39");
    ...
    //     return null;
    // }
    createHeaderSignature(httpMethod: string, uri: string, jsonString: any, signatureKey: string, queryParams: string): string {
