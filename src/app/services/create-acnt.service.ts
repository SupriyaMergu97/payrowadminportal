...
export class CreateAcntService {
  ...
  constructor(private http: HttpClient,private encryption:SignatureEncryptionService) { }

  createPayrowId(body: any,headers:any): Observable<any> {
    
    return this.http.put(`${environment.Onboarding_URL}/payrowId`, body,{headers}).pipe(catchError(err => of(err)));;
  }
  ...
  getPridbyId(id: any,headers:any): Observable<any> {
    ...
    return this.http.get(`${environment.Onboarding_URL}/payrowId/${id}`,{ headers })
  }
  // updatePayrowId(boddy)
  createMerchant(body: any,headers:any): Observable<any> {
    
    return this.http.post(`${environment.Onboarding_URL}/merchant`, body,{headers}).pipe(catchError(err => of(err)));;
  }
  updateMerchant(body: any,headers:any): Observable<any> {
    
    return this.http.put(`${environment.Onboarding_URL}/merchant`, body,{headers})
  }
  ...
  getMerbyid(id: any,headers:any): Observable<any> {
    ...
    return this.http.get(`${environment.Onboarding_URL}/merchant/${id}`,{headers})
  }
  getMerchantsbyPrid(prid: any,headers:any): Observable<any> {
    
    return this.http.get(`${environment.Onboarding_URL}/merchant/getbyPrid/${prid}`,{headers})
  }
  getForm(): Observable<any> {
    return this.http.get(`https://payrowdev.uaenorth.cloudapp.azure.com/merchant/merchantAgreement`, { responseType: 'text' })
  }
  getTidList(mid: any,headers:any): Observable<any> {
    
    return this.http.get(`${environment.Onboarding_URL}/terminalId/${mid}`,{headers})
  }
  getAllTids(headers:any): Observable<any> {
    
    return this.http.get(`${environment.Onboarding_URL}/terminalId`,{headers})
  }
  createTerminalId(body: any,headers:any): Observable<any> {
    
    return this.http.post(`${environment.Onboarding_URL}/terminalId`, body,{headers})
  }
  createTidbyFile(body: any,headers:any): Observable<any> {
    
    return this.http.post(`${environment.Onboarding_URL}/terminalId/uploadFile`, body,{headers}).pipe(catchError(err => of(err)));;
  }
  addServtoMerchant(body: any,headers:any): Observable<any> {
    
    return this.http.post(`${environment.gateway_URL}/posMerServices/create`, body,{headers})
  }
  getMerItems(headers:any): Observable<any> {
    
    return this.http.get(`${environment.gateway_URL}/posMerServices/list`,{headers})
  }
