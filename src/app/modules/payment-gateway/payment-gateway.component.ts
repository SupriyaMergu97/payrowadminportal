...
export class PaymentGatewayComponent implements OnInit {
    ...
    constructor(public fb: FormBuilder,
        private app: AppManagerService, private bar_Service: BarServiceService, private http: HttpClient
    ) {
    ...
    public marker: Object = {
        dataLabel: {
            // visible: true, 
            // template:'<div><div><img src="/admin/assets/images/bakery1.png" width="40px"></div></div>' ,
    ...
    async getItems() {
        this.http.get<any>('../admin/assets/jsons/currentStatusMarket.json').subscribe(
            (data) => {
    ...
    async getMarketFilterItems() {
        this.http.get<any>('../admin/assets/jsons/marketItems.json').subscribe(
            (data) => {
                this.marketDataStore = data;
